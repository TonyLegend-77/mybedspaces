...
export default function PropertyTabs({
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-4 md:px-8 md:py-8">
      <div className="sticky top-[57px] z-20 -mx-4 flex gap-5 overflow-x-auto border-b border-neutral-200 bg-white px-4 py-2 text-sm md:-mx-8 md:px-8">
        {TABS.map((tab) => (
          <button
            key={tab}
      ...
      <div className="fixed bottom-16 left-0 right-0 z-30 border-t border-neutral-200 bg-white px-4 py-3 md:bottom-0">
